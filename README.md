...
The packaged app reports its version, commit, UTC build time, and release repository in **Settings > About**. Local builds use the development version derived from `package.json` (for example, `1.0.3-dev`).
